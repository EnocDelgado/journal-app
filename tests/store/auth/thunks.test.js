...
describe('Tets on AuthThunks', () => {
    ...
    test('startGoogleSignIn should call checkingCredentials and login - Done', async() => {
    ...
    test('startLoginWithEmailPassword should call checkingCredentials and login - Done', async() => {
